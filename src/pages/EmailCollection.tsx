  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow questionnaire-container">
        <section className="py-10 px-4 sm:py-16 md:py-24">
          <div className="ayur-container max-w-xl mx-auto">
            {/* Header */}
            <div className="text-center mb-6 sm:mb-10 animate-fade-in-up">
              <div className="inline-flex items-center gap-2 text-accent mb-3 sm:mb-4">
                ...
                <span className="text-xs sm:text-sm font-medium uppercase tracking-wider">Begin Your Journey</span>
              </div>
              <h1 className="font-cormorant text-3xl sm:text-4xl md:text-5xl font-medium text-foreground mb-3 sm:mb-4">
                Discover Your Dosha
              </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="text-sm sm:text-base py-5 sm:py-6 rounded-xl border-border/50 focus:border-accent"
                    />
                  </div>
                  ...
                  <div className="space-y-2 sm:space-y-3 py-3 sm:py-4">
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-accent mt-0.5 flex-shrink-0" />
                      <p className="text-xs sm:text-sm text-muted-foreground">Personalized dosha analysis based on Ayurvedic wisdom</p>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Leaf className="w-4 h-4 sm:w-5 sm:h-5 text-primary mt-0.5 flex-shrink-0" />
                      <p className="text-xs sm:text-sm text-muted-foreground">Custom food, lifestyle, and gut health recommendations</p>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-accent mt-0.5 flex-shrink-0" />
                      <p className="text-xs sm:text-sm text-muted-foreground">Insights for daily balance and self-awareness</p>
                    </div>
                  </div>
                  
                  <Button 
                    type="submit" 
                    className="w-full btn-gold text-base sm:text-lg py-5 sm:py-6"
            ...
            {/* Trust indicators */}
            <div className="text-center mt-6 sm:mt-8 animate-fade-in-up animate-delay-200">
