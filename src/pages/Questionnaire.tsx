          ...
          <div className="container max-w-4xl">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-ayurveda-forest/80 max-w-2xl mx-auto">
                Answer the following questions honestly based on your natural tendencies throughout your life, not just your current state. This will help determine your unique Ayurvedic body blueprint.
              </p>
            </div>
